...
/**
 * The gaussdb implementation of ConfigInfoAggrMapper.
 * Supports pg / ora / mysql compatible modes.
 *
 * @author hyx
 **/
public class ConfigInfoAggrMapperByGaussDb extends AbstractMapperByGaussDb implements ConfigInfoAggrMapper {
    ...
    public MapperResult findConfigInfoAggrByPageFetchRows(MapperContext context) {
        ...
        if (GaussdbCompatibleModeUtil.isOraMode()) {
            sql = buildWrappedPagination(baseSql, startRow, pageSize);
        } else {
            sql = baseSql + buildPagination(startRow, pageSize);
        }
